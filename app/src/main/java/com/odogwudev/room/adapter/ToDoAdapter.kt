package com.odogwudev.room.adapter
...
import com.odogwudev.room.databinding.ItemTodoRecyclerviewBinding
import com.odogwudev.room.enums.Prioirities
import com.odogwudev.room.model.ToDo
import com.odogwudev.room.R
import com.odogwudev.room.fragments.RecyclerViewFragmentDirections
...
class ToDoAdapter(val context: Context) : RecyclerView.Adapter<ToDoAdapter.ToDoHolder>() {
    ...
    inner class ToDoHolder(val binding: ItemTodoRecyclerviewBinding) :
        ...
        override fun onClick(view: View) {
            ...
            val action = RecyclerViewFragmentDirections.actionRecyclerFragmentToAddToDoDialog(
                listOfToDos[adapterPosition],
                adapterPosition
            )
