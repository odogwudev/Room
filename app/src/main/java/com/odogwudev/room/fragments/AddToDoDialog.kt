package com.odogwudev.room.fragments
...
import com.odogwudev.room.databinding.FragmentAddToDoDialogBinding
import com.odogwudev.room.enums.Prioirities
import com.odogwudev.room.model.ToDo
import com.odogwudev.room.viewmodel.ToDoViewModel
...
class AddToDoDialog : DialogFragment() {
    ...
    private fun createToDo() = ToDo(
        ...
        "${String.format("%02d", binding.dpDueDate.dayOfMonth)}.${
            String.format(
                "%02d",
                binding.dpDueDate.month
            )
        }.${String.format("%04d", binding.dpDueDate.year)}",
